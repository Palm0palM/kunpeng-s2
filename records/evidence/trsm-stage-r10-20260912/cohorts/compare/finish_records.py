#!/usr/bin/env python3
"""Register collected r10 logs without running task code or computing digests."""
...
names = ['T8-control12-repeat-r10', 'T13-sve4x32']
...
wide = (DEST / 'preflight-wide32-results/T13-sve4x32/completion.txt').read_text().strip()
...
wide_summary = json.loads((DEST / 'preflight-wide32-results/T13-sve4x32/summary.json').read_text())
