"""Read-only r15 audit for two repeats; unchanged r14 preflight output contracts."""
import json
import math
...
MEMBERS = {
    'T8-control12-repeat-r15': (False, False, False),
    'T18-budgetwide-repeat-r15': (True, True, True),
}
