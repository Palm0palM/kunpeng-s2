...
/* Two independent RHS8 panels share each of eight row coefficients.
 * L starts at this row block, column zero; both X panels retain row zero.
 * Every output accumulates k in order before one subtraction and division. */
__attribute__((target("arch=armv8-a+sve"), noinline))
static void solve8x16_panel_sve(int start,int lda,const double *L,double *x0,double *x1)
{
    trsm_test_wide_arguments(start,lda,L,x0,x1);
    svbool_t pg=svptrue_b64();
    svfloat64_t a0_0=svdup_n_f64(0);
    svfloat64_t a0_1=svdup_n_f64(0);
    svfloat64_t a1_0=svdup_n_f64(0);
    svfloat64_t a1_1=svdup_n_f64(0);
    svfloat64_t a2_0=svdup_n_f64(0);
    svfloat64_t a2_1=svdup_n_f64(0);
    svfloat64_t a3_0=svdup_n_f64(0);
    svfloat64_t a3_1=svdup_n_f64(0);
    svfloat64_t a4_0=svdup_n_f64(0);
    svfloat64_t a4_1=svdup_n_f64(0);
    svfloat64_t a5_0=svdup_n_f64(0);
    svfloat64_t a5_1=svdup_n_f64(0);
    svfloat64_t a6_0=svdup_n_f64(0);
    svfloat64_t a6_1=svdup_n_f64(0);
    svfloat64_t a7_0=svdup_n_f64(0);
    svfloat64_t a7_1=svdup_n_f64(0);
    /* Adjacent history coefficients share one base address; each sum still
     * consumes k before k+1. The original one-step body handles the tail. */
    int k=0;
    for(;k+1<start;k+=2) {
        svfloat64_t previous0=svld1_f64(pg,x0+(size_t)k*RHS);
        svfloat64_t previous1=svld1_f64(pg,x1+(size_t)k*RHS);
        svfloat64_t next0=svld1_f64(pg,x0+(size_t)(k+1)*RHS);
        svfloat64_t next1=svld1_f64(pg,x1+(size_t)(k+1)*RHS);
        { const double *coefficients=L+(size_t)0*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a0_0=svmla_f64_x(pg,a0_0,previous0,coefficient0);
            a0_1=svmla_f64_x(pg,a0_1,previous1,coefficient0);
            a0_0=svmla_f64_x(pg,a0_0,next0,coefficient1);
            a0_1=svmla_f64_x(pg,a0_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)1*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a1_0=svmla_f64_x(pg,a1_0,previous0,coefficient0);
            a1_1=svmla_f64_x(pg,a1_1,previous1,coefficient0);
            a1_0=svmla_f64_x(pg,a1_0,next0,coefficient1);
            a1_1=svmla_f64_x(pg,a1_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)2*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a2_0=svmla_f64_x(pg,a2_0,previous0,coefficient0);
            a2_1=svmla_f64_x(pg,a2_1,previous1,coefficient0);
            a2_0=svmla_f64_x(pg,a2_0,next0,coefficient1);
            a2_1=svmla_f64_x(pg,a2_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)3*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a3_0=svmla_f64_x(pg,a3_0,previous0,coefficient0);
            a3_1=svmla_f64_x(pg,a3_1,previous1,coefficient0);
            a3_0=svmla_f64_x(pg,a3_0,next0,coefficient1);
            a3_1=svmla_f64_x(pg,a3_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)4*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a4_0=svmla_f64_x(pg,a4_0,previous0,coefficient0);
            a4_1=svmla_f64_x(pg,a4_1,previous1,coefficient0);
            a4_0=svmla_f64_x(pg,a4_0,next0,coefficient1);
            a4_1=svmla_f64_x(pg,a4_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)5*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a5_0=svmla_f64_x(pg,a5_0,previous0,coefficient0);
            a5_1=svmla_f64_x(pg,a5_1,previous1,coefficient0);
            a5_0=svmla_f64_x(pg,a5_0,next0,coefficient1);
            a5_1=svmla_f64_x(pg,a5_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)6*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a6_0=svmla_f64_x(pg,a6_0,previous0,coefficient0);
            a6_1=svmla_f64_x(pg,a6_1,previous1,coefficient0);
            a6_0=svmla_f64_x(pg,a6_0,next0,coefficient1);
            a6_1=svmla_f64_x(pg,a6_1,next1,coefficient1);
        }
        { const double *coefficients=L+(size_t)7*lda+k;
            svfloat64_t coefficient0,coefficient1;
            __asm__("ld1rd %0.d, %2/z, [%3]\n\t"
                    "ld1rd %1.d, %2/z, [%3, #8]"
                    : "=w"(coefficient0), "=w"(coefficient1)
                    : "Upl"(pg), "r"(coefficients),
                      "m"(coefficients[0]), "m"(coefficients[1]));
            a7_0=svmla_f64_x(pg,a7_0,previous0,coefficient0);
            a7_1=svmla_f64_x(pg,a7_1,previous1,coefficient0);
            a7_0=svmla_f64_x(pg,a7_0,next0,coefficient1);
            a7_1=svmla_f64_x(pg,a7_1,next1,coefficient1);
        }
    }
    for(;k<start;++k) {
        svfloat64_t previous0=svld1_f64(pg,x0+(size_t)k*RHS);
        svfloat64_t previous1=svld1_f64(pg,x1+(size_t)k*RHS);
        { double coefficient=L[(size_t)0*lda+k];
            a0_0=svmla_n_f64_x(pg,a0_0,previous0,coefficient);
            a0_1=svmla_n_f64_x(pg,a0_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)1*lda+k];
            a1_0=svmla_n_f64_x(pg,a1_0,previous0,coefficient);
            a1_1=svmla_n_f64_x(pg,a1_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)2*lda+k];
            a2_0=svmla_n_f64_x(pg,a2_0,previous0,coefficient);
            a2_1=svmla_n_f64_x(pg,a2_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)3*lda+k];
            a3_0=svmla_n_f64_x(pg,a3_0,previous0,coefficient);
            a3_1=svmla_n_f64_x(pg,a3_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)4*lda+k];
            a4_0=svmla_n_f64_x(pg,a4_0,previous0,coefficient);
            a4_1=svmla_n_f64_x(pg,a4_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)5*lda+k];
            a5_0=svmla_n_f64_x(pg,a5_0,previous0,coefficient);
            a5_1=svmla_n_f64_x(pg,a5_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)6*lda+k];
            a6_0=svmla_n_f64_x(pg,a6_0,previous0,coefficient);
            a6_1=svmla_n_f64_x(pg,a6_1,previous1,coefficient);
        }
        { double coefficient=L[(size_t)7*lda+k];
            a7_0=svmla_n_f64_x(pg,a7_0,previous0,coefficient);
            a7_1=svmla_n_f64_x(pg,a7_1,previous1,coefficient);
        }
    }
    svfloat64_t solved0,solved1;
    double diagonal;
    diagonal=L[(size_t)0*lda+start+0];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+0)*RHS),a0_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+0)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+0)*RHS),a0_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+0)*RHS,solved1);
    { double coefficient=L[(size_t)1*lda+start+0];
        a1_0=svmla_n_f64_x(pg,a1_0,solved0,coefficient);
        a1_1=svmla_n_f64_x(pg,a1_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)2*lda+start+0];
        a2_0=svmla_n_f64_x(pg,a2_0,solved0,coefficient);
        a2_1=svmla_n_f64_x(pg,a2_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)3*lda+start+0];
        a3_0=svmla_n_f64_x(pg,a3_0,solved0,coefficient);
        a3_1=svmla_n_f64_x(pg,a3_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)4*lda+start+0];
        a4_0=svmla_n_f64_x(pg,a4_0,solved0,coefficient);
        a4_1=svmla_n_f64_x(pg,a4_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)5*lda+start+0];
        a5_0=svmla_n_f64_x(pg,a5_0,solved0,coefficient);
        a5_1=svmla_n_f64_x(pg,a5_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)6*lda+start+0];
        a6_0=svmla_n_f64_x(pg,a6_0,solved0,coefficient);
        a6_1=svmla_n_f64_x(pg,a6_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)7*lda+start+0];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)1*lda+start+1];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+1)*RHS),a1_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+1)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+1)*RHS),a1_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+1)*RHS,solved1);
    { double coefficient=L[(size_t)2*lda+start+1];
        a2_0=svmla_n_f64_x(pg,a2_0,solved0,coefficient);
        a2_1=svmla_n_f64_x(pg,a2_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)3*lda+start+1];
        a3_0=svmla_n_f64_x(pg,a3_0,solved0,coefficient);
        a3_1=svmla_n_f64_x(pg,a3_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)4*lda+start+1];
        a4_0=svmla_n_f64_x(pg,a4_0,solved0,coefficient);
        a4_1=svmla_n_f64_x(pg,a4_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)5*lda+start+1];
        a5_0=svmla_n_f64_x(pg,a5_0,solved0,coefficient);
        a5_1=svmla_n_f64_x(pg,a5_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)6*lda+start+1];
        a6_0=svmla_n_f64_x(pg,a6_0,solved0,coefficient);
        a6_1=svmla_n_f64_x(pg,a6_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)7*lda+start+1];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)2*lda+start+2];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+2)*RHS),a2_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+2)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+2)*RHS),a2_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+2)*RHS,solved1);
    { double coefficient=L[(size_t)3*lda+start+2];
        a3_0=svmla_n_f64_x(pg,a3_0,solved0,coefficient);
        a3_1=svmla_n_f64_x(pg,a3_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)4*lda+start+2];
        a4_0=svmla_n_f64_x(pg,a4_0,solved0,coefficient);
        a4_1=svmla_n_f64_x(pg,a4_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)5*lda+start+2];
        a5_0=svmla_n_f64_x(pg,a5_0,solved0,coefficient);
        a5_1=svmla_n_f64_x(pg,a5_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)6*lda+start+2];
        a6_0=svmla_n_f64_x(pg,a6_0,solved0,coefficient);
        a6_1=svmla_n_f64_x(pg,a6_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)7*lda+start+2];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)3*lda+start+3];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+3)*RHS),a3_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+3)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+3)*RHS),a3_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+3)*RHS,solved1);
    { double coefficient=L[(size_t)4*lda+start+3];
        a4_0=svmla_n_f64_x(pg,a4_0,solved0,coefficient);
        a4_1=svmla_n_f64_x(pg,a4_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)5*lda+start+3];
        a5_0=svmla_n_f64_x(pg,a5_0,solved0,coefficient);
        a5_1=svmla_n_f64_x(pg,a5_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)6*lda+start+3];
        a6_0=svmla_n_f64_x(pg,a6_0,solved0,coefficient);
        a6_1=svmla_n_f64_x(pg,a6_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)7*lda+start+3];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)4*lda+start+4];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+4)*RHS),a4_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+4)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+4)*RHS),a4_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+4)*RHS,solved1);
    { double coefficient=L[(size_t)5*lda+start+4];
        a5_0=svmla_n_f64_x(pg,a5_0,solved0,coefficient);
        a5_1=svmla_n_f64_x(pg,a5_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)6*lda+start+4];
        a6_0=svmla_n_f64_x(pg,a6_0,solved0,coefficient);
        a6_1=svmla_n_f64_x(pg,a6_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)7*lda+start+4];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)5*lda+start+5];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+5)*RHS),a5_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+5)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+5)*RHS),a5_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+5)*RHS,solved1);
    { double coefficient=L[(size_t)6*lda+start+5];
        a6_0=svmla_n_f64_x(pg,a6_0,solved0,coefficient);
        a6_1=svmla_n_f64_x(pg,a6_1,solved1,coefficient);
    }
    { double coefficient=L[(size_t)7*lda+start+5];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)6*lda+start+6];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+6)*RHS),a6_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+6)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+6)*RHS),a6_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+6)*RHS,solved1);
    { double coefficient=L[(size_t)7*lda+start+6];
        a7_0=svmla_n_f64_x(pg,a7_0,solved0,coefficient);
        a7_1=svmla_n_f64_x(pg,a7_1,solved1,coefficient);
    }
    diagonal=L[(size_t)7*lda+start+7];
    solved0=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x0+(size_t)(start+7)*RHS),a7_0),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x0+(size_t)(start+7)*RHS,solved0);
    solved1=svdiv_f64_x(pg,
        svsub_f64_x(pg,svld1_f64(pg,x1+(size_t)(start+7)*RHS),a7_1),
        svdup_n_f64(diagonal));
    svst1_f64(pg,x1+(size_t)(start+7)*RHS,solved1);
}

/* Only a safely computed over-budget history request selects this path.
 * Keep RHS=8 globally: one worker allocation contains [2][m][RHS]. */
static void solve_panel_wide8x16(int m,int n,const double *L,int lda,double *B,int ldb)
{
    if(m<=0 || n<=0) return;
    const int have_sve=(getauxval(AT_HWCAP)&HWCAP_SVE)!=0;
    const int tasks=n/(2*RHS)+(n%(2*RHS)!=0);
#pragma omp parallel
    {
        const int use_sve=have_sve && trsm_sve_has_eight_doubles();
        double *scratch=NULL;
        if((size_t)m<=SIZE_MAX/(2*RHS*sizeof(double))) {
            if(posix_memalign((void**)&scratch,64,(size_t)m*(2*RHS)*sizeof(double))!=0)
                scratch=NULL;
        }
#pragma omp for schedule(static)
        for(int task=0;task<tasks;++task) {
            const int jb=task*(2*RHS);
            const int w=n-jb<2*RHS?n-jb:2*RHS;
            if(!scratch) {
                /* Failure is local to this worker's assigned 16-column tasks. */
                for(int j=jb;j<jb+w;++j)for(int i=0;i<m;++i) {
                    double sum=0;
                    for(int k=0;k<i;++k)sum+=L[(size_t)i*lda+k]*B[(size_t)k*ldb+j];
                    B[(size_t)i*ldb+j]=(B[(size_t)i*ldb+j]-sum)/L[(size_t)i*lda+i];
                }
                continue;
            }
            double *x0=scratch;
            double *x1=scratch+(size_t)m*RHS;
            const int panels=(w+RHS-1)/RHS;
            for(int panel=0;panel<panels;++panel) {
                double *x=scratch+(size_t)panel*m*RHS;
                const int width=w-panel*RHS<RHS?w-panel*RHS:RHS;
                for(int i=0;i<m;++i) {
                    for(int j=0;j<width;++j)x[(size_t)i*RHS+j]=B[(size_t)i*ldb+jb+panel*RHS+j];
                    for(int j=width;j<RHS;++j)x[(size_t)i*RHS+j]=0;
                }
            }
            int wide_rows=0;
            if(use_sve && w==2*RHS) {
                for(;m-wide_rows>=8;wide_rows+=8)
                    solve8x16_panel_sve(wide_rows,lda,L+(size_t)wide_rows*lda,x0,x1);
            }
            for(int panel=0;panel<panels;++panel) {
                double *x=scratch+(size_t)panel*m*RHS;
                const int width=w-panel*RHS<RHS?w-panel*RHS:RHS;
                int first_row=wide_rows;
                /* A short column task retains the original RHS8 SVE blocks. */
                if(use_sve && w<2*RHS) {
...
#pragma omp simd
                ...
                for(int i=0;i<m;++i)for(int j=0;j<width;++j)
                    B[(size_t)i*ldb+jb+panel*RHS+j]=x[(size_t)i*RHS+j];
            }
        }
        free(scratch);
    }
...
/* Implementation budget for the shared triangular history copy, not hardware cache size. */
enum { TRSM_PACKED_HISTORY_BUDGET_BYTES = 4 * 1024 * 1024 };
#endif
static void solve_panel(int m,int n,const double *L,int lda,double *B,int ldb)
{
    ...
    if(have_sve && full_blocks>=2) {
        ...
        if(blocks<=SIZE_MAX/(blocks-1)) {
            ...
            if(pairs<=SIZE_MAX/(128*sizeof(double))) {
                ...
                if(bytes<=TRSM_PACKED_HISTORY_BUDGET_BYTES) {
    ...
    if(history_over_budget) {
        solve_panel_wide8x16(m,n,L,lda,B,ldb);
        return;
    }
#endif
#pragma omp parallel
...
/* Four eight-column panels reuse each L coefficient across four FMA chains.
 * panel_stride is KB*RHS for packed X and RHS for strided original B.
 * Each output retains a zero-based increasing-k sum, followed by C-sum. */
__attribute__((target("arch=armv8-a+sve"), noinline))
static void update4x32_sve(int count,const double *L,int lda,const double *X0,int ldx,int panel_stride,double *C,int ldc)
{
    const double *X1=X0+(size_t)panel_stride;
    const double *X2=X0+(size_t)2*panel_stride;
    const double *X3=X0+(size_t)3*panel_stride;
    svbool_t pg=svptrue_b64();
    svfloat64_t a0_0=svdup_n_f64(0);
    svfloat64_t a0_8=svdup_n_f64(0);
    svfloat64_t a0_16=svdup_n_f64(0);
    svfloat64_t a0_24=svdup_n_f64(0);
    svfloat64_t a1_0=svdup_n_f64(0);
    svfloat64_t a1_8=svdup_n_f64(0);
    svfloat64_t a1_16=svdup_n_f64(0);
    svfloat64_t a1_24=svdup_n_f64(0);
    svfloat64_t a2_0=svdup_n_f64(0);
    svfloat64_t a2_8=svdup_n_f64(0);
    svfloat64_t a2_16=svdup_n_f64(0);
    svfloat64_t a2_24=svdup_n_f64(0);
    svfloat64_t a3_0=svdup_n_f64(0);
    svfloat64_t a3_8=svdup_n_f64(0);
    svfloat64_t a3_16=svdup_n_f64(0);
    svfloat64_t a3_24=svdup_n_f64(0);
    for(int k=0;k<count;++k) {
        svfloat64_t x0=svld1_f64(pg,X0+(size_t)k*ldx);
        svfloat64_t x1=svld1_f64(pg,X1+(size_t)k*ldx);
        svfloat64_t x2=svld1_f64(pg,X2+(size_t)k*ldx);
        svfloat64_t x3=svld1_f64(pg,X3+(size_t)k*ldx);
        { double a=L[(size_t)0*lda+k];
            a0_0=svmla_n_f64_x(pg,a0_0,x0,a);
            a0_8=svmla_n_f64_x(pg,a0_8,x1,a);
            a0_16=svmla_n_f64_x(pg,a0_16,x2,a);
            a0_24=svmla_n_f64_x(pg,a0_24,x3,a);
        }
        { double a=L[(size_t)1*lda+k];
            a1_0=svmla_n_f64_x(pg,a1_0,x0,a);
            a1_8=svmla_n_f64_x(pg,a1_8,x1,a);
            a1_16=svmla_n_f64_x(pg,a1_16,x2,a);
            a1_24=svmla_n_f64_x(pg,a1_24,x3,a);
        }
        { double a=L[(size_t)2*lda+k];
            a2_0=svmla_n_f64_x(pg,a2_0,x0,a);
            a2_8=svmla_n_f64_x(pg,a2_8,x1,a);
            a2_16=svmla_n_f64_x(pg,a2_16,x2,a);
            a2_24=svmla_n_f64_x(pg,a2_24,x3,a);
        }
        { double a=L[(size_t)3*lda+k];
            a3_0=svmla_n_f64_x(pg,a3_0,x0,a);
            a3_8=svmla_n_f64_x(pg,a3_8,x1,a);
            a3_16=svmla_n_f64_x(pg,a3_16,x2,a);
            a3_24=svmla_n_f64_x(pg,a3_24,x3,a);
        }
    }
    svst1_f64(pg,C+(size_t)0*ldc+0,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)0*ldc+0),a0_0));
    svst1_f64(pg,C+(size_t)0*ldc+8,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)0*ldc+8),a0_8));
    svst1_f64(pg,C+(size_t)0*ldc+16,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)0*ldc+16),a0_16));
    svst1_f64(pg,C+(size_t)0*ldc+24,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)0*ldc+24),a0_24));
    svst1_f64(pg,C+(size_t)1*ldc+0,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)1*ldc+0),a1_0));
    svst1_f64(pg,C+(size_t)1*ldc+8,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)1*ldc+8),a1_8));
    svst1_f64(pg,C+(size_t)1*ldc+16,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)1*ldc+16),a1_16));
    svst1_f64(pg,C+(size_t)1*ldc+24,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)1*ldc+24),a1_24));
    svst1_f64(pg,C+(size_t)2*ldc+0,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)2*ldc+0),a2_0));
    svst1_f64(pg,C+(size_t)2*ldc+8,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)2*ldc+8),a2_8));
    svst1_f64(pg,C+(size_t)2*ldc+16,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)2*ldc+16),a2_16));
    svst1_f64(pg,C+(size_t)2*ldc+24,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)2*ldc+24),a2_24));
    svst1_f64(pg,C+(size_t)3*ldc+0,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)3*ldc+0),a3_0));
    svst1_f64(pg,C+(size_t)3*ldc+8,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)3*ldc+8),a3_8));
    svst1_f64(pg,C+(size_t)3*ldc+16,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)3*ldc+16),a3_16));
    svst1_f64(pg,C+(size_t)3*ldc+24,svsub_f64_x(pg,svld1_f64(pg,C+(size_t)3*ldc+24),a3_24));
}
                ...
                if(use_sve) {
                    for(;ie-first_row>=16;first_row+=16) {
                        ...
                        for(;j+32<=je;j+=32) {
                            ...
                            int xstride=packed?RHS:ldb,panel_stride=packed?KB*RHS:RHS;
                            update4x32_sve(end-kk,L+(size_t)first_row*lda+kk,lda,xp,xstride,panel_stride,B+(size_t)first_row*ldb+j,ldb);
                            update4x32_sve(end-kk,L+(size_t)(first_row+4)*lda+kk,lda,xp,xstride,panel_stride,B+(size_t)(first_row+4)*ldb+j,ldb);
                            update4x32_sve(end-kk,L+(size_t)(first_row+8)*lda+kk,lda,xp,xstride,panel_stride,B+(size_t)(first_row+8)*ldb+j,ldb);
                            update4x32_sve(end-kk,L+(size_t)(first_row+12)*lda+kk,lda,xp,xstride,panel_stride,B+(size_t)(first_row+12)*ldb+j,ldb);
                        }
                        for(;j<je;j+=8) {
                ...
                for(int i=first_row;i<ie;i+=4) {
                    ...
                    if(use_sve && ie-i>=4) {
                        for(;j+32<=je;j+=32) {
                            const double *xp=packed?packed+(size_t)(j/RHS)*KB*RHS:B+(size_t)kk*ldb+j;
                            int xstride=packed?RHS:ldb,panel_stride=packed?KB*RHS:RHS;
                            update4x32_sve(end-kk,L+(size_t)i*lda+kk,lda,xp,xstride,panel_stride,B+(size_t)i*ldb+j,ldb);
                        }
                    }
#endif
                    for(;j<je;j+=8) {
