...
for remote,local in [('preflight.log','preflight.log'),('wrapper.stdout.log','cohort.stdout.log'),('preflight/environment-probe.log','reference-environment.log'),('preflight/trsm-panel.s','trsm-panel.s'),('preflight/trsm-update.s','trsm-update.s')]:
...
env=fields['HOST']+'-numa'+fields['NUMA_NODE']+'-gcc10-generic38-openblas028-test3-job'+g['job_id']
ref='OpenBLAS 0.3.28 static USE_OPENMP ARMV8 MAX_THREADS=38; official KML unavailable in compute-node probe; not official KML revalidation'
