...
for remote,local in [('preflight.log','preflight.log'),('wrapper.stdout.log','cohort.stdout.log'),('preflight/environment-probe.log','reference-environment.log'),('preflight/trsm-16rows.s','trsm-16rows.s'),('preflight/trsm-panelpair.s','trsm-panelpair.s')]:
