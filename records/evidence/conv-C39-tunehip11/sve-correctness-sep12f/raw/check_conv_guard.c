...
int main(int argc, char **argv) {
    ...
    if (smoke) {
        ...
        /* Reduced independent tune coverage: retain all 24 original boundary widths,
         * eight kernels and five heights, including four actual quad workers. */
        const int pair_outs[] = {15,16,17,23,24,25,31,32,33,47,48,49,63,64,65,95,96,97,127,128,129,191,192,193};
        const int pair_kernels[][2] = {{4,1},{4,2},{4,3},{4,4},{7,7},{7,8},{8,7},{8,8}};
        const int pair_heights[] = {2,3,4,5,16};
    ...
    return count == (smoke ? 96 : 7108) ? 0 : 6;
}
