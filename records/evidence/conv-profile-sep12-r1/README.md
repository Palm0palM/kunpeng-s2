...
```text
python3 .runs/diagnostics/conv-profile-sep12-r1/driver.py config/conv-sep12.local.json submit --go
python3 .runs/diagnostics/conv-profile-sep12-r1/driver.py config/conv-sep12.local.json status
python3 .runs/diagnostics/conv-profile-sep12-r1/driver.py config/conv-sep12.local.json fetch
```
