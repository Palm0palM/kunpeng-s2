...
#include <stdint.h>
#include <omp.h>
#include "../T7-sve24rows/source/trsm.c"
...
static int microcheck(void) {
    ...
    for(size_t q=0;q<sizeof(strides)/sizeof(strides[0]);++q) {
        ...
        size_t nl=(size_t)24*lda,nx=(size_t)(count+1)*ldx,nc=(size_t)24*ldc;
