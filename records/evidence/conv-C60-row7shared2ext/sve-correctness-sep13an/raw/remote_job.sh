...
[[ "$CANDIDATE" == C60-row7shared2ext && "$EXPECTED_ACC" == 3 ]]
...
write_manifest() {
    ...
    printf '%s  conv2d.c\n' 10df62b8d43c59a6164de7d23c1b59ab954bbaaebc330d57662e8f5d6b7f2168 LOCAL_USER sha256sum -c - LOCAL_USERLOCAL_USER return "$?"
