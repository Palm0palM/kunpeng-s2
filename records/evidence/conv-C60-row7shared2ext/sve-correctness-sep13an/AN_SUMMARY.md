...
候选 C60-row7shared2ext，原作业 1589554。首次 status/fetch 均退出0，调度器 SUCCEEDED，job/system/wrapper = 0/0/0。
...
原始日志在 raw/；完整逐配置、source关联、资源及两次外层argv/UTC/输出路径见 AN_SUMMARY.json。主额度检查38%，未使用reset；此子任务完成后停止。
