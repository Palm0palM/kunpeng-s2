...
import cluster
cfg=cluster.load_config(ROOT/'.runs/trsm/optimization-20260911-r2/cluster.local.json')
...
if sys.argv[1:]==['prepare']:
    ...
    settings=cluster.read_json(ROOT/'.runs/trsm/T4-control8/experiment.json')['settings']
