...
static void solve8x16_panel_sve(int start,int lda,const double *L,double *x0,double *x1)
{
    ...
    /* Keep each history sum in increasing-k order, with two steps per loop.
     * The original single-step tail covers odd, zero and short histories. */
    int k=0;
    for(;k+1<start;k+=2) {
        {
        ...
        {
            svfloat64_t previous0=svld1_f64(pg,x0+(size_t)(k+1)*RHS);
            svfloat64_t previous1=svld1_f64(pg,x1+(size_t)(k+1)*RHS);
            { double coefficient=L[(size_t)0*lda+(k+1)];
                a0_0=svmla_n_f64_x(pg,a0_0,previous0,coefficient);
                a0_1=svmla_n_f64_x(pg,a0_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)1*lda+(k+1)];
                a1_0=svmla_n_f64_x(pg,a1_0,previous0,coefficient);
                a1_1=svmla_n_f64_x(pg,a1_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)2*lda+(k+1)];
                a2_0=svmla_n_f64_x(pg,a2_0,previous0,coefficient);
                a2_1=svmla_n_f64_x(pg,a2_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)3*lda+(k+1)];
                a3_0=svmla_n_f64_x(pg,a3_0,previous0,coefficient);
                a3_1=svmla_n_f64_x(pg,a3_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)4*lda+(k+1)];
                a4_0=svmla_n_f64_x(pg,a4_0,previous0,coefficient);
                a4_1=svmla_n_f64_x(pg,a4_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)5*lda+(k+1)];
                a5_0=svmla_n_f64_x(pg,a5_0,previous0,coefficient);
                a5_1=svmla_n_f64_x(pg,a5_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)6*lda+(k+1)];
                a6_0=svmla_n_f64_x(pg,a6_0,previous0,coefficient);
                a6_1=svmla_n_f64_x(pg,a6_1,previous1,coefficient);
            }
            { double coefficient=L[(size_t)7*lda+(k+1)];
                a7_0=svmla_n_f64_x(pg,a7_0,previous0,coefficient);
                a7_1=svmla_n_f64_x(pg,a7_1,previous1,coefficient);
            }
        }
