...
[[ "$CANDIDATE" == C63-row7x2shared4rowwise && "$EXPECTED_ACC" == 2 ]]
...
write_manifest() {
    ...
    printf '%s  conv2d.c\n' d78a863eb49c85d415420819e4b6ef8379260a34ad9f118da5bab1bdca7e94a8 LOCAL_USER sha256sum -c - LOCAL_USERLOCAL_USER return "$?"
