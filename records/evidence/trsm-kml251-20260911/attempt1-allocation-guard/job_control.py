...
import cluster
cfg=cluster.load_config(ROOT/'.runs/trsm/optimization-20260911-r4/cluster.local.json')
...
''')
    ...
    for remote in ['benchmark.log','environment.log','exit-code.txt','probe.log','probe-ldd.log','benchmark-ldd-1.log','benchmark-ldd-2.log','benchmark-ldd-3.log','wrapper.stdout.log']:
        location=remote if remote=='wrapper.stdout.log' else 'results/'+remote
