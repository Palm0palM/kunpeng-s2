...
int main(void) {
 const int outs[]={1,2,3,4,7,8,9,15,16,17,23,24,25,31,32,33,47,48,49,63,64,65,79,80,81,95,96,97,111,112,113,127,128,129,191,192,193,255,256,257};
 ...
 for(int pad=0;pad<2;pad++) {
  int kw=kernels[b],kh=kernels[b],ow=outs[a],oh=3,W=ow+kw-1,H=oh+kh-1;
