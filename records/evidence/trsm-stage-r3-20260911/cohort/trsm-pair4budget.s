...
.LFE4289:
	...
	.align	2
	.p2align 4,,11
	.type	solve_panel_grouped._omp_fn.0, %function
solve_panel_grouped._omp_fn.0:
.LFB4288:
	.cfi_startproc
	sub	sp, sp, #704
...
.L405:
	...
	.cfi_endproc
.LFE4288:
	.size	solve_panel_grouped._omp_fn.0, .-solve_panel_grouped._omp_fn.0
	.align	2
	.p2align 4,,11
	.global	l_trsm
...
.LFB4286:
	...
	cmp	x0, 262144
	bhi	.L543
	adrp	x0, solve_panel_grouped._omp_fn.0
	add	x0, x0, :lo12:solve_panel_grouped._omp_fn.0
	mov	w3, 0
.L549:
	add	x1, sp, 80
	mov	w2, 0
