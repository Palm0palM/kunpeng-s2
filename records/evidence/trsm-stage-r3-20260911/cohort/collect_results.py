...
for remote,local in [('preflight.log','preflight.log'),('wrapper.stdout.log','cohort.stdout.log'),('preflight/environment-probe.log','reference-environment.log'),('preflight/trsm-pair2budget.s','trsm-pair2budget.s'),('preflight/trsm-pair4budget.s','trsm-pair4budget.s')]:
