...
int main(int argc, char **argv) {
    ...
    if (smoke) {
        ...
        const int pair_outs[] = {15,16,17,23,24,25,31,32,33,47,48,49,63,64,65,95,96,97,127,128,129,191,192,193,255,256,257,511,512,513};
    ...
    return count == (smoke ? 96 : 21748) ? 0 : 6;
}
