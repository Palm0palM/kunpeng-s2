...
if len(sys.argv) != 4 or sys.argv[1] not in ('C34-colmajor256', 'C35-prefetch2') or sys.argv[3] not in ('submit', 'status', 'fetch'):
...
expected_full_cases, expected_smoke_cases, expected_probe_cases = {'C34-colmajor256': (21748,96,0), 'C35-prefetch2': (29668,168,18)}[version]
