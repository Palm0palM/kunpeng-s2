"""Read-only r16 audit for two repeats; unchanged r14 preflight output contracts."""
import json
import math
...
MEMBERS = {
    'T8-control12-repeat-r16': (False, False, False),
    'T18-budgetwide-repeat-r16': (True, True, True),
}
