...
for remote,local in [('preflight.log','preflight.log'),('wrapper.stdout.log','cohort.stdout.log'),('preflight/environment-probe.log','reference-environment.log'),('preflight/trsm-8rows.s','trsm-8rows.s')]:
