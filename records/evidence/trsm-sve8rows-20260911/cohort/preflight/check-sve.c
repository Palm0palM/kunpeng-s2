...
#include <stdint.h>
#include <omp.h>
#include "../T4-sve8rows/source/trsm.c"
...
static int microcheck(void) {
    ...
    for(size_t q=0;q<sizeof(strides)/sizeof(strides[0]);++q) {
        ...
        size_t nl=(size_t)8*lda,nx=(size_t)(count+1)*ldx,nc=(size_t)8*ldc;
