            ...
            for (; kw - ik >= 2; ik += 2) {
                {
                    ...
                    /* One source-level input window; GCC may reschedule. */
                    {
                        ...
                        a0 = svmla_f32_x(pg, a0, v, ak);
                        b0 = svmla_f32_x(pg, b0, v, bk);
                        c0 = svmla_f32_x(pg, c0, v, ck);
                        d0 = svmla_f32_x(pg, d0, v, dk);
                        e0 = svmla_f32_x(pg, e0, v, ek);
                        f0 = svmla_f32_x(pg, f0, v, fk);
                        g0 = svmla_f32_x(pg, g0, v, gk);
                    }
                    {
                        const svfloat32_t v = svld1(pg, row + column + 1 * lanes);
                        a1 = svmla_f32_x(pg, a1, v, ak);
                        b1 = svmla_f32_x(pg, b1, v, bk);
                        c1 = svmla_f32_x(pg, c1, v, ck);
                        d1 = svmla_f32_x(pg, d1, v, dk);
                        e1 = svmla_f32_x(pg, e1, v, ek);
                        f1 = svmla_f32_x(pg, f1, v, fk);
                        g1 = svmla_f32_x(pg, g1, v, gk);
                    }
                    {
                        const svfloat32_t v = svld1(pg, row + column + 2 * lanes);
                        a2 = svmla_f32_x(pg, a2, v, ak);
                        b2 = svmla_f32_x(pg, b2, v, bk);
                        c2 = svmla_f32_x(pg, c2, v, ck);
                        d2 = svmla_f32_x(pg, d2, v, dk);
                        e2 = svmla_f32_x(pg, e2, v, ek);
                        f2 = svmla_f32_x(pg, f2, v, fk);
                        g2 = svmla_f32_x(pg, g2, v, gk);
                    }
                }
                {
