                               ...
                               float *restrict dst2, int ow)
{
    ...
    for (; ow - i >= block; i += block) {
        ...
        svfloat32_t c5 = svdup_n_f32(0.0f);
        /* Input row 0 contributes only to output 0. */
        {
            ...
            for (; ik < kw - 1; ik += 2) {
                ...
                /* Shift only the final valid window; do not load v6. */
        ...
        for (int t = 2; t < kh; ++t) {
            ...
            for (; ik < kw - 1; ik += 2) {
                ...
                /* Consume all three completed outputs before new window loads. */
                __asm__ __volatile__("" :
                    : "w"(a0), "w"(b0), "w"(c0) : "memory");
                const svfloat32_t v2 = svld1(pg, p + 2 * lanes);
                const svfloat32_t x1 = svext_f32(v1, v2, 1);
                a1 = svadd_f32_x(pg, a1, svmul_f32_x(pg, v1, ak0));
                a1 = svadd_f32_x(pg, a1, svmul_f32_x(pg, x1, ak1));
                ...
                b4 = svadd_f32_x(pg, b4, svmul_f32_x(pg, v4, bk0));
                b4 = svadd_f32_x(pg, b4, svmul_f32_x(pg, x4, bk1));
                c4 = svadd_f32_x(pg, c4, svmul_f32_x(pg, v4, ck0));
                c4 = svadd_f32_x(pg, c4, svmul_f32_x(pg, x4, ck1));
                __asm__ __volatile__("" :
                    : "w"(a4), "w"(b4), "w"(c4) : "memory");
                /* Shift only the final valid window; do not load v6. */
                const svfloat32_t x5 = svld1(pg, p + 5 * lanes + 1);
                a5 = svadd_f32_x(pg, a5, svmul_f32_x(pg, v5, ak0));
                a5 = svadd_f32_x(pg, a5, svmul_f32_x(pg, x5, ak1));
                b5 = svadd_f32_x(pg, b5, svmul_f32_x(pg, v5, bk0));
                b5 = svadd_f32_x(pg, b5, svmul_f32_x(pg, x5, bk1));
                c5 = svadd_f32_x(pg, c5, svmul_f32_x(pg, v5, ck0));
                c5 = svadd_f32_x(pg, c5, svmul_f32_x(pg, x5, ck1));
            }
            for (; ik < kw; ++ik) {
                const svfloat32_t ak = svdup_n_f32(ka[ik]);
                const svfloat32_t bk = svdup_n_f32(kb[ik]);
                ...
                a4 = svadd_f32_x(pg, a4, svmul_f32_x(pg, v4, ak));
                b4 = svadd_f32_x(pg, b4, svmul_f32_x(pg, v4, bk));
                c4 = svadd_f32_x(pg, c4, svmul_f32_x(pg, v4, ck));
                const svfloat32_t v5 = svld1(pg, row + ik + 5 * lanes);
                a5 = svadd_f32_x(pg, a5, svmul_f32_x(pg, v5, ak));
                b5 = svadd_f32_x(pg, b5, svmul_f32_x(pg, v5, bk));
                c5 = svadd_f32_x(pg, c5, svmul_f32_x(pg, v5, ck));
            }
        }
            ...
            CONVFLOAT *output)
{
    ...
    if (use_sve) {
        /* Avoid oh+2 and j+2: the group start is always a valid output row. */
        const int groups = oh / 3 + (oh % 3 != 0);
