...
{
    trsm_test_wide_arguments(ldx,panel_stride);
    ...
    /* Preserve each increasing-k FMA chain while amortizing loop control.
     * The scalar tail retains zero, odd and short count behavior. */
    int k=0;
    for(;k+1<count;k+=2) {
        {
        ...
        /* Keep first-step accumulators ready before loading the next X/L.
         * These empty statements constrain the compiler; they emit no CPU fence. */
        __asm__ __volatile__(""
            : "+w"(a0_0), "+w"(a0_8), "+w"(a0_16), "+w"(a0_24),
              "+w"(a1_0), "+w"(a1_8), "+w"(a1_16), "+w"(a1_24)
            : : "memory");
        __asm__ __volatile__(""
            : "+w"(a2_0), "+w"(a2_8), "+w"(a2_16), "+w"(a2_24),
              "+w"(a3_0), "+w"(a3_8), "+w"(a3_16), "+w"(a3_24)
            : : "memory");
        {
            svfloat64_t x0=svld1_f64(pg,X0+(size_t)(k+1)*ldx);
            svfloat64_t x1=svld1_f64(pg,X1+(size_t)(k+1)*ldx);
            svfloat64_t x2=svld1_f64(pg,X2+(size_t)(k+1)*ldx);
            svfloat64_t x3=svld1_f64(pg,X3+(size_t)(k+1)*ldx);
            { double a=L[(size_t)0*lda+k+1];
                a0_0=svmla_n_f64_x(pg,a0_0,x0,a);
                a0_8=svmla_n_f64_x(pg,a0_8,x1,a);
                a0_16=svmla_n_f64_x(pg,a0_16,x2,a);
                a0_24=svmla_n_f64_x(pg,a0_24,x3,a);
            }
            { double a=L[(size_t)1*lda+k+1];
                a1_0=svmla_n_f64_x(pg,a1_0,x0,a);
                a1_8=svmla_n_f64_x(pg,a1_8,x1,a);
                a1_16=svmla_n_f64_x(pg,a1_16,x2,a);
                a1_24=svmla_n_f64_x(pg,a1_24,x3,a);
            }
            { double a=L[(size_t)2*lda+k+1];
                a2_0=svmla_n_f64_x(pg,a2_0,x0,a);
                a2_8=svmla_n_f64_x(pg,a2_8,x1,a);
                a2_16=svmla_n_f64_x(pg,a2_16,x2,a);
                a2_24=svmla_n_f64_x(pg,a2_24,x3,a);
            }
            { double a=L[(size_t)3*lda+k+1];
                a3_0=svmla_n_f64_x(pg,a3_0,x0,a);
                a3_8=svmla_n_f64_x(pg,a3_8,x1,a);
                a3_16=svmla_n_f64_x(pg,a3_16,x2,a);
                a3_24=svmla_n_f64_x(pg,a3_24,x3,a);
