...
#ifndef EXPECTED_ACC
#error "Pass EXPECTED_ACC=16 for the selected source."
#endif
struct guarded {
    void *mapping;
...
int main(int argc, char **argv) {
    ...
    const int outs[] = {1,2,3,4,7,8,9,15,16,17,23,24,25,31,32,33,47,48,49,63,64,65,
                        79,80,81,95,96,97,111,112,113,127,128,129,191,192,193,255,256,257,383,384,385,511,512,513};
    ...
    return count == (smoke ? 24 : 3496) ? 0 : 6;
}
