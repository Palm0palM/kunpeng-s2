...
[[ "$CANDIDATE" == C52-row7x3shared2 && "$EXPECTED_ACC" == 3 ]]
...
write_manifest() {
    ...
    printf '%s  conv2d.c\n' 8cf5dc086d0fd6c7ce21f0f5cfd2bbf50da820a9c18e12de328e970a28712bf7 | sha256sum -c - || return "$?"
