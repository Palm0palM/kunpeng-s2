...
int main(int argc, char **argv) {
    ...
    printf("DISPATCH_ROWSEVEN_ACTUAL_ENTRIES=%lu EXPECTED=756 WORKER_MASK=%lu EXPECTED_MASK=%lu\n",dispatch_entries,dispatch_mask,expected_mask);
    if (dispatch_count!=972 || dispatch_entries!=756 || dispatch_mask!=expected_mask ||
