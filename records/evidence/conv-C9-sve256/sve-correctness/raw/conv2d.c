 ...
 * an independent output; sixteen accumulators span the entire kernel. Keep the
    ...
    for (; ow - i >= block; i += block) {
        ...
        for (int jk = 0; jk < kh; ++jk) {
            ...
            for (; ik < kw - 1; ik += 2) {
                ...
                a0 = svadd_f32_x(pg, a0, svmul_f32_x(pg, svld1(pg, p), k0));
                a1 = svadd_f32_x(pg, a1, svmul_f32_x(pg, svld1(pg, p + lanes), k0));
                a2 = svadd_f32_x(pg, a2, svmul_f32_x(pg, svld1(pg, p + 2 * lanes), k0));
                a3 = svadd_f32_x(pg, a3, svmul_f32_x(pg, svld1(pg, p + 3 * lanes), k0));
                a4 = svadd_f32_x(pg, a4, svmul_f32_x(pg, svld1(pg, p + 4 * lanes), k0));
                a5 = svadd_f32_x(pg, a5, svmul_f32_x(pg, svld1(pg, p + 5 * lanes), k0));
                a6 = svadd_f32_x(pg, a6, svmul_f32_x(pg, svld1(pg, p + 6 * lanes), k0));
                a7 = svadd_f32_x(pg, a7, svmul_f32_x(pg, svld1(pg, p + 7 * lanes), k0));
                a8 = svadd_f32_x(pg, a8, svmul_f32_x(pg, svld1(pg, p + 8 * lanes), k0));
                a9 = svadd_f32_x(pg, a9, svmul_f32_x(pg, svld1(pg, p + 9 * lanes), k0));
                a10 = svadd_f32_x(pg, a10, svmul_f32_x(pg, svld1(pg, p + 10 * lanes), k0));
                a11 = svadd_f32_x(pg, a11, svmul_f32_x(pg, svld1(pg, p + 11 * lanes), k0));
                a12 = svadd_f32_x(pg, a12, svmul_f32_x(pg, svld1(pg, p + 12 * lanes), k0));
                a13 = svadd_f32_x(pg, a13, svmul_f32_x(pg, svld1(pg, p + 13 * lanes), k0));
                a14 = svadd_f32_x(pg, a14, svmul_f32_x(pg, svld1(pg, p + 14 * lanes), k0));
                a15 = svadd_f32_x(pg, a15, svmul_f32_x(pg, svld1(pg, p + 15 * lanes), k0));
                a0 = svadd_f32_x(pg, a0, svmul_f32_x(pg, svld1(pg, p + 1), k1));
                a1 = svadd_f32_x(pg, a1, svmul_f32_x(pg, svld1(pg, p + lanes + 1), k1));
                a2 = svadd_f32_x(pg, a2, svmul_f32_x(pg, svld1(pg, p + 2 * lanes + 1), k1));
                a3 = svadd_f32_x(pg, a3, svmul_f32_x(pg, svld1(pg, p + 3 * lanes + 1), k1));
                a4 = svadd_f32_x(pg, a4, svmul_f32_x(pg, svld1(pg, p + 4 * lanes + 1), k1));
                a5 = svadd_f32_x(pg, a5, svmul_f32_x(pg, svld1(pg, p + 5 * lanes + 1), k1));
                a6 = svadd_f32_x(pg, a6, svmul_f32_x(pg, svld1(pg, p + 6 * lanes + 1), k1));
                a7 = svadd_f32_x(pg, a7, svmul_f32_x(pg, svld1(pg, p + 7 * lanes + 1), k1));
                a8 = svadd_f32_x(pg, a8, svmul_f32_x(pg, svld1(pg, p + 8 * lanes + 1), k1));
                a9 = svadd_f32_x(pg, a9, svmul_f32_x(pg, svld1(pg, p + 9 * lanes + 1), k1));
                a10 = svadd_f32_x(pg, a10, svmul_f32_x(pg, svld1(pg, p + 10 * lanes + 1), k1));
                a11 = svadd_f32_x(pg, a11, svmul_f32_x(pg, svld1(pg, p + 11 * lanes + 1), k1));
                a12 = svadd_f32_x(pg, a12, svmul_f32_x(pg, svld1(pg, p + 12 * lanes + 1), k1));
                a13 = svadd_f32_x(pg, a13, svmul_f32_x(pg, svld1(pg, p + 13 * lanes + 1), k1));
                a14 = svadd_f32_x(pg, a14, svmul_f32_x(pg, svld1(pg, p + 14 * lanes + 1), k1));
