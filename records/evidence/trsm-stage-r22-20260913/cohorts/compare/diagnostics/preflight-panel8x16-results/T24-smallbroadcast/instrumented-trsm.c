...
static void solve8x16_panel_sve(int start,int lda,const double *L,double *x0,double *x1)
{
    ...
    for(int k=0;k<start;++k) {
        ...
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)0*lda+k]));
            a0_0=svmla_f64_x(pg,a0_0,previous0,coefficient);
            a0_1=svmla_f64_x(pg,a0_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)1*lda+k]));
            a1_0=svmla_f64_x(pg,a1_0,previous0,coefficient);
            a1_1=svmla_f64_x(pg,a1_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)2*lda+k]));
            a2_0=svmla_f64_x(pg,a2_0,previous0,coefficient);
            a2_1=svmla_f64_x(pg,a2_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)3*lda+k]));
            a3_0=svmla_f64_x(pg,a3_0,previous0,coefficient);
            a3_1=svmla_f64_x(pg,a3_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)4*lda+k]));
            a4_0=svmla_f64_x(pg,a4_0,previous0,coefficient);
            a4_1=svmla_f64_x(pg,a4_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)5*lda+k]));
            a5_0=svmla_f64_x(pg,a5_0,previous0,coefficient);
            a5_1=svmla_f64_x(pg,a5_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)6*lda+k]));
            a6_0=svmla_f64_x(pg,a6_0,previous0,coefficient);
            a6_1=svmla_f64_x(pg,a6_1,previous1,coefficient);
        }
        { svfloat64_t coefficient;
            /* Read exactly one coefficient and broadcast without a scalar move. */
            __asm__("ld1rd %0.d, %1/z, %2"
                    : "=w"(coefficient)
                    : "Upl"(pg), "Q"(L[(size_t)7*lda+k]));
            a7_0=svmla_f64_x(pg,a7_0,previous0,coefficient);
            a7_1=svmla_f64_x(pg,a7_1,previous1,coefficient);
        }
    }
