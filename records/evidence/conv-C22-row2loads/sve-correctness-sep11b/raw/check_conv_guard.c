...
#ifndef EXPECTED_ACC
#error "Pass EXPECTED_ACC=6 for row2x6 or 4 for row3x4/row2loads, per output row."
#endif
struct guarded {
    void *mapping;
...
int main(int argc, char **argv) {
    ...
    if (smoke) {
        ...
        /* Pair/triple coverage: all row-group remainders and four 3-row groups.
        ...
        const int pair_heights[] = {1,2,3,4,5,6,7,8,12};
    ...
    return count == (smoke ? 72 : 13636) ? 0 : 6;
}
