...
2026-09-13 第二十三轮：T25 成对系数加载中例快 **3.65%**，但大例慢 **1.41%**、合计改善 **0.74%** 未过 **6.78%** 波动门槛，不晋级。18/18 正式、6/6 预热及两版完整预检通过，保留 T19。[完整记录](trsm-stage-r23-20260913.md)。

2026-09-13 第二十二轮：T24 显式广播加载中例快 **0.40%**、合计快 **0.29%**，低于 **10.61%** 波动门槛，不晋级。18/18 正式、6/6 预热及两版完整小路径预检通过，保留 T19。[完整记录](trsm-stage-r22-20260913.md)。

2026-09-13 第二十一轮：T23 小路径两步展开中用例慢 **7.33%**、合计慢 **3.25%**，不晋级。18/18 正式、6/6 预热及两版全量小路径预检通过，保留 T19。[完整记录](trsm-stage-r21-20260913.md)。

2026-09-13 第二十轮：T22 去掉 memory clobber 后，整个目标汇编与 T21 相同；合计比 T19 慢 **2.10%**，不晋级。T20 合计快 **2.12%**，低于 **12.42%** 波动门槛。27/27 正式、9/9 预热及全部宽核预检通过，保持 T19，转向小路径历史循环。[完整记录](trsm-stage-r20-20260913.md)。

2026-09-13 第十九轮：T21 将两步展开的 MOVPRFX 从 8 条减至 1 条，但大例比同期 T20 慢 **3.29%**；T20/T21 合计快 **2.72% / 0.61%**，均未越过波动门槛，不晋级。27/27 正式、9/9 预热及全部宽核预检通过，保持 T19。[完整记录](trsm-stage-r19-20260913.md)。

2026-09-13 第十八轮：T20 同源码确认大例快 **3.26%**、合计快 **2.67%**，仍未超过 **3.30%** 波动门槛，不晋级。18/18 正式、6/6 预热及宽核预检通过，保持 T19 提交包；下一步独立考察展开后寄存器活跃范围。[完整记录](trsm-stage-r18-20260913.md)。

2026-09-13 第十七轮：T20 的 4×32 SVE 两步展开大例快 **3.70%**、合计快 **1.50%**，未超过 **4.67%** 波动门槛，中例慢 **1.70%**，不晋级。18/18 正式、6/6 预热及宽核预检通过；当前实现与提交包保持 T19，测量台账为 T19-control13。[完整记录](trsm-stage-r17-20260913.md)。
