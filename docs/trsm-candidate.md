...
2026-09-11 当前最佳已晋级为 **T4-sve8rows**：同分配三轮合计 545.31→526.19 ms，耗时减少 **3.51%**，大用例减少 **6.97%**，18/18 官方结果 PASS。详见[8 行 SVE 记录](trsm-sve8rows-20260911.md)和[提交包记录](trsm-package-20260911.md)。
