...
CONV C5 的最终 ZIP 三轮复验 12/12 PASS、最大误差 0；ZGEMM Z1 保留已验证的原包；TRSM T4 复用 main 已发布的原包，其参考库为 OpenBLAS，官方 KML 复验仍待完成。TRSM 原记录明确未执行远端哈希验证，本次仅核对 Git 对象与复制后的本地包身份，不改变历史验证结论。
